module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, sanitize_text=true, attachment=nil, message_timestamp = Time.now, metadata=nil)
      ...
      def reply(conversation, recipients, reply_body, subject=nil, sanitize_text=true, attachment=nil, metadata=nil)
